...
export const fieldValidations = Yup.object().shape({
    ...
    port: Yup.number().typeError('El puerto debe ser un número').required(t(lang.Organization.validation.portIsRequired.toString())),
    ...
    tipobd: Yup.string().required(t(lang.Organization.validation.tipoBDIsRequired.toString()))
