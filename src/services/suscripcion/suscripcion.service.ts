...
import { SuscripcionDeleteDTO, SuscripcionPatchDTO, SuscripcionPostDTO } from '../../model/dtos/suscripcion/suscripcion.dto';
...
class Suscripcion {
    ...
    async deleteSuscripcion(SuscripcionId: SuscripcionDeleteDTO) {
        return await Axios.delete(replaceParamId(url.delete, SuscripcionId.id), { cancelToken: cancelTokenSource.token, });
    }
}
